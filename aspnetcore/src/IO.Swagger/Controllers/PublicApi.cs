...
{ 
    ...
    { 
        ...
        public virtual IActionResult SearchNumber([FromQuery]int? num1, [FromQuery]int? num2, [FromQuery]string add, [FromQuery]string subtract, [FromQuery]string multiply, [FromQuery]string divide, [FromQuery]string power)
        { 
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(List<Calculator>), description: "search results matching criteria")]
        public virtual IActionResult UpdateNumber([FromQuery]int? num1, [FromQuery]int? num2, [FromQuery]string add, [FromQuery]string subtract, [FromQuery]string multiply, [FromQuery]string divide, [FromQuery]string power)
        { 
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(List<Calculator>));
