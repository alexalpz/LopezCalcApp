...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (is_numeric($response)) {
        #Calculator to verify tanget of an angle result: http://www.math.com/students/calculators/source/tangent.htm
...
<body>
    <h1>Tangent of an Angle</h1>
    <h4>Final by Alexa Lopez</h4>

    <!--Formula for determining tangent from MathOpenRef:https://www.mathopenref.com/trigtangent.html#:~:text=In%20any%20right%20triangle%2C%20the,written%20simply%20as%20'tan'.&text=Often%20remembered%20as%20%22SOH%22%20%2D,See%20SOH%20CAH%20TOA.
